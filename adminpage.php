...
<header>
  ...
  <div style="font-size: 20px; color: darkblue; transition: width 0.3s ease; margin-top: 1.5rem; text-align:center" ><b>Welcome Admin Page <i class="fa-solid fa-user-lock"></i></b></div>
  <div class="container">

<div class="sidebar">
    <div style="color: darkblue;"><h5>Join Requests :</h5></div></br>
    <table>
    <tr>
      <th>name</th>
      <th>email</th>
  ...
  <div class="content">
    ...
    <div style="padding: 60px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.4);  " >
  <div class="row">
    <div class="col">
      <?php
include('inc/connection.php');
